...
spiaLB <- 0.2     # minimum percent allocation of savings to SPIA to simulate
spiaUB <- 0.2    # maximum percent allocation of savings to SPIA to simulate
...
spendUB <- 1.1  # maximum percent of initial spending simulated
spendLB <- .9   # minimum percent of initial spending simulated
...
# Need to make this a vector here and in function
...
if (wifeAge == 0 | husbandAge == 0) {numberRetiring <- 1} else {numberRetiring <- 2}
spendM <- buildSpendM (states, initspend, annualAdjust,survivorExpense,numberRetiring)
