...
askChangeNote <- readline(prompt="What changed since the last run?   ")
...
set.seed(27514)
equityAllocation <- sample(seq(0.2,0.7,.1),n,replace=TRUE)   # randomize equity allocations from zer0 to 100%

# equityAllocation <- 0  # percent of portfolio exposed to 
...
initialSpend <- 250000 # 230000            # expected spending year one of retirement
